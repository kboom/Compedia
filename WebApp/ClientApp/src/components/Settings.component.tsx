...
import { accountActionCreators } from "../store/account";
...
const StyledSettings = styled.div<{ isMenuOpen: boolean }>`
  ...
  background: ${({ isMenuOpen }) =>
    `rgba(0, 0, 0, ${isMenuOpen ? 0.6 : 0.45})`};
...
export const Settings: FunctionComponent = () => {
  ...
  useOnClickOutside(settingsLinkRef, onMenuClickOutside, CLICK_OUTSIDE_EVENTS);
